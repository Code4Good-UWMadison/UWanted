...
class EditDrawerPage extends StatefulWidget {
  EditDrawerPage(
      {Key key,
      @required this.auth,
      @required this.userId,
  ...
  @override
  _EditDrawerPageState createState() => _EditDrawerPageState();
}

class _EditDrawerPageState extends State<EditDrawerPage> {
